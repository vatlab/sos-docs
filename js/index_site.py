...
def generate_tipue_content(docs_dir):
    ...
    text = [parse_html(url, html) for (url, html) in [
            ('https://vatlab.github.io/SoS/', 'Overview.html'),
            ('https://vatlab.github.io/SoS/#features', 'Features.html'),
            ('https://vatlab.github.io/SoS/#runningsos', 'Running_SoS.html'),
            ('https://vatlab.github.io/SoS/#documentation', 'Documentation.html')] + 
